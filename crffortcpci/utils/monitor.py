...
class MonitorCollector(object):
    ...
    def collect(self, scenario_provider, available_time, experiment, t, policy, reward_function,
                metric: EvaluationMetric, total_build_duration,
                prioritization_time, rewards, prioritization_order):
        """
        ...
        # ttf_time = metric.detection_ranks_time[0] if len(metric.detection_ranks_time) > 0 else 0
